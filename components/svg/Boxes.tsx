    ...
    <>
      ...
      >
        <g>
          <polygon
            style={{ fill: '#FFE6B8' }}
            points='256.001,474.063 10.2,363.126 10.2,149.41 256.001,255.997 	'
          />
          <polygon
            style={{ fill: '#FFE6B8' }}
            points='256.001,474.063 501.802,363.126 501.802,149.41 256.001,255.997 	'
          />
        </g>
        <g>
          <polygon
            style={{ fill: '#FFAD61' }}
            points='256.001,255.997 256.001,37.93 10.2,149.41 	'
          />
          <polygon
            style={{ fill: '#FFAD61' }}
            points='256.001,255.997 256.001,37.93 501.802,149.41 	'
          />
        </g>
        <polygon
          style={{ fill: '#D35B38' }}
          points='346.273,361.496 424.089,326.375 424.089,258.716 346.273,292.459 '
        />
        <g>
          <path
            style={{ fill: '#4D3D36' }}
            d='M511.995,149.408c-0.002-3.998-2.334-7.632-5.981-9.286L260.213,28.642
		...
		V164.95z M491.603,356.541L266.2,458.271v-195.58l210.225-91.159l15.177-6.582V356.541z'
          ...
          <path
            style={{ fill: '#4D3D36' }}
            d='M400.83,137.58h-7.139c-5.632,0-10.199,4.567-10.199,10.199s4.567,10.199,10.199,10.199h7.139
		c5.632,0,10.199-4.567,10.199-10.199S406.462,137.58,400.83,137.58z'
          />
          <path
            style={{ fill: '#4D3D36' }}
            d='M429.686,250.189c-2.872-1.885-6.502-2.196-9.655-0.83l-77.817,33.743
