    ...
    >
      <div className='relative mx-auto my-auto w-full rounded-xl shadow-lg md:max-w-4xl md:bg-white'>
        <div className='fixed flex w-full justify-end pr-1 md:relative'>
          <button
            className='my-auto px-2 focus:outline-none'
            onClick={handleOpen}
          >
          ...
          <table className='w-full max-w-full'>
            <thead className='justify-between'>
              <tr className='bg-gray-400'>
                ...
                <th className='px-6 py-4 text-lg font-semibold capitalize'>
                  Title
                </th>
                <th className='px-6 py-4 text-lg font-semibold capitalize'>
                  Price
                ...
                <th className='px-6 py-4 text-center text-lg font-semibold capitalize'>
                  Quantity
                </th>
                <th className='px-6 py-4 text-center text-lg font-semibold capitalize'>
                  Total Amount
