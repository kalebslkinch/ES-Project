      ...
      {!close && (
        <div className='mx-auto flex w-full max-w-xs animate-fadein overflow-hidden rounded-lg bg-white  shadow-md'>
          ...
          <div className='-mx-3 w-5/6 px-4 py-2'>
            <div className='mx-3'>
              <span className='-mtext-green-400 font-semibold  text-green-500'>
                Success
              </span>
              <p className='-mtext-gray-200 text-sm  text-gray-600'>
          ...
          <button
            onClick={handleClose}
            className='align-start flex focus:outline-none '
          >
