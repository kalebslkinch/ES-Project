...
const WWOStatement: FC<{ percentageAboutUs: number; percentageContactUs: number; refContactUs: Ref<any> }> = ({
	percentageAboutUs,
	percentageContactUs,
	refContactUs
}) => {
		...
		<>
			...
			<h2
				style={{
					...
					transform: `scale(${0.8 + parseFloat(percentageAboutUs.toPrecision(2))})`
				}}
			...
			<h2
				style={{
					transform: `translateX(${parseFloat(percentageContactUs.toPrecision(2)) * 800}px)`,
					opacity:
			...
			<h2
				style={{
					transform: `translateX(${parseFloat(percentageContactUs.toPrecision(2)) * 300}px)`,
					opacity:
						parseFloat(percentageContactUs.toPrecision(2)) < 0.4
							? 0.4 + parseFloat(percentageContactUs.toPrecision(2))
			...
			<h2
				style={{
					transform: `translateX(${parseFloat(percentageContactUs.toPrecision(2)) * 200}px)`,
					opacity:
						parseFloat(percentageContactUs.toPrecision(2)) < 0.4
							? 0.4 + parseFloat(percentageContactUs.toPrecision(2))
