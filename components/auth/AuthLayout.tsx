		...
		<div className="flex items-center justify-center h-[90vh]">
			<div className="flex flex-col items-center justify-center border w-96 h-[400px] rounded-lg shadow-md">
				...
				>
					...
					<span className="text-lg sm:text-xl ml-5 font-medium">Continue with Google</span>
				</button>
				...
				>
					...
					<span className="text-lg sm:text-xl ml-5 font-medium">Continue with Twitter</span>
				</button>
