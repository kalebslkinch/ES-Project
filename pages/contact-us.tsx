...
import { ContactMessage } from '../utils/types/contactmessage';
      ...
      <Col className='mx-auto w-full max-w-2xl overflow-hidden bg-white py-4 sm:px-6'>
        <TransitionContactUS>
          ...
          <div className='mt-6 grid grid-cols-1 gap-6 md:-translate-x-6 md:grid-cols-3'>
            <a
              href='#'
              className='flex flex-col items-center rounded-md py-3 px-4 hover:bg-blue-200'
            >
            ...
            <a
              href='#'
              className='flex flex-col items-center rounded-md px-4 py-3 text-gray-800 hover:bg-blue-200'
            >
          ...
          <form
            ...
            onSubmit={handleSubmit(handleAlert)}
          >
            <div className='mx-4 mt-6 sm:mx-0'>
              ...
              <div className='mt-4 w-full sm:ml-0'>
                {/* Message */}
                <label className='mb-2 ml-1 block text-sm font-medium text-gray-800 sm:ml-0'>
                  Message*
                </label>
